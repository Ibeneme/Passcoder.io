...
const UndergraduateDegree = () => {
  ...
  return (
    <div className='max-w-[700px] mx-auto my-16 p-4'>
        <form
    >
      <h1 className='extended-first-div-h1'>University, Polytechnic or College Certificate</h1>
    ...
    <div className='flex flex-col py-2'>
       <label className='py-2 font-medium'>Upload a copy of your Degree Certificate</label>
        <input 
        style={{ height:"6em"}}
        type = 'file'
        accept='image/*'
...
export default UndergraduateDegree