...
const FSL = () => {
  ...
  return (
    ...
    <form
>
  <h1 className='extended-first-div-h1'>First School Leaving Certificate</h1>
...
<div className='flex flex-col py-2'>
   <label className='py-2 font-medium'>Upload a copy of your First School leaving Certificate</label>
    <input 
    style={{ height:"6em"}}
    type = 'file'
    accept='image/*'
