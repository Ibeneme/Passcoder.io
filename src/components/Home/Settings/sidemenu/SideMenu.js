  ...
  return (
   <div className='sidemenu-bar'>
        ...
        <div className='sidemenu-contents'>
            <div>
                <p className='sidemenu-items' onClick={(event)=>{navigate('/Dashboard')}}> <GiHamburgerMenu   className='sidemenu-icons'/> <span className='p-content'> Dashboard</span></p>
            </div>
            <div>
                <p className='sidemenu-items' onClick={(event)=>{navigate('/Browse-Apps')}}  ><TiTabsOutline  className='sidemenu-icons' /> <span className='p-content'> Browse Apps </span></p>
            </div>
            ...
            <div onClick={(event)=>{navigate('/Settings')}}>
                <p className='sidemenu-items hover' > <FiSettings  className='sidemenu-icons'/><span className='p-content'> Settings </span> </p>
            </div>
        </div>
