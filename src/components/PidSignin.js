  ...
  return (
    <div>
      ...
      style={{
        ...
        <p style={{fontSize:'0.9em', color:"red"}}>Your Passcoder ID or Password not Correct, or you do not have an account with us
    </p> 
      </div>
      </Link> : 
      ...
      <form onSubmit={handleSubmit}>
        <div className='flex flex-col py-2'>
          <label className='py-2 font-medium'>Passcoder ID</label>
          <input 
      ...
      <button 
        ...
        <span style={{display:'flex', justifyContent:'center', alignItems:'center'}}>
            ...
            <p>Sign in with Email</p> </span></button> 
{/*   
        <button 
